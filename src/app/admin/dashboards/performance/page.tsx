'use client';
import Balance from '@/components/admin/dashboards/performance/Balance';
import DailyTraffic from '@/components/admin/dashboards/performance/DailyTraffic';
import MostVisited from '@/components/admin/dashboards/performance/MostVisitedTable';
import OverallRevenue from '@/components/admin/dashboards/performance/OverallRevenue';
import ProfitEstimation from '@/components/admin/dashboards/performance/ProfitEstimation';
import ProjectStatus from '@/components/admin/dashboards/performance/ProjectStatus';
import YourCard from '@/components/admin/dashboards/performance/YourCard';
import YourTransfers from '@/components/admin/dashboards/performance/YourTransfers';
