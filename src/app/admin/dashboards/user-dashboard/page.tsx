'use client';
import Statistics from '@/components/admin/dashboards/user-dashboard/Statistics';
// Assets
...
import Conversion from '@/components/admin/dashboards/user-dashboard/Conversion';
import UserActivity from '@/components/admin/dashboards/user-dashboard/UserActivity';
import Consumption from '@/components/admin/dashboards/user-dashboard/Consumption';
import tableDataUserReports from '@/variables/users/users-reports/tableDataUserReports';
import UserReportsTable from '@/components/admin/dashboards/user-dashboard/UserReportsTable';
