...
// Custom Image component to handle className and style props
const Image = ({ className, style, ...props }: any) => {
  return (
...
const Icon = (IconComponent: React.ComponentType<any>, className: string, size: number = 18) => (
  ...
  return (
    <>
      <button
        ...
        onClick={onOpen}
      >
        {Icon(MdSettings, "h-[18px] w-[18px] text-gray-400 dark:text-white")}
      </button>
      <Drawer
        isOpen={isOpen}
        onClose={onClose}
        ...
        children={
          <DrawerContent className="my-4 ml-0 mr-4 w-[calc(100vw_-_32px)] max-w-[calc(100vw_-_32px)] rounded-2xl bg-white shadow-[-20px_17px_40px_4px_rgba(112,_144,_176,_0.18)] dark:bg-navy-800 dark:shadow-[-22px_32px_51px_4px_#0B1437] sm:ml-4 md:w-[400px] md:max-w-[400px]">
            ...
            >
              ...
              >
                {Icon(MdRefresh, "h-[22px] w-[22px] text-gray-900 dark:text-white", 22)}
              </div>
            ...
            >
              ...
              >
                ...
                {isFullscreen 
                  ? Icon(MdOutlineFullscreenExit, "ml-1.5 h-[18px] w-[18px] text-gray-900 dark:text-white")
                  : Icon(MdFullscreen, "ml-1.5 h-[18px] w-[18px] text-gray-900 dark:text-white")
                }
              </button>
            </DrawerBody>
          </DrawerContent>
