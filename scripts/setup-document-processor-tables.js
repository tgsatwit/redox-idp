...
/**
 * Script to set up the necessary DynamoDB tables for the document processor system
 * Run with: node scripts/setup-document-processor-tables.js
 */
...
// Table names matching existing naming convention
const CONFIG_TABLE = 'document-processor-config';
const RETENTION_POLICY_TABLE = 'document-processor-retention-policies';
const STORAGE_SOLUTIONS_TABLE = 'document-processor-storage-solutions';
...
async function setupTables() {
  try {
    console.log('Setting up DynamoDB tables with document-processor prefix...');
    
    // Create storage solutions table (we focus only on this one since others already exist)
